...
public class FileUtil {
    ...
    public static File getBasePath(Context context) {
        ...
        if (isSDCardAvailable()) {
            appDir = new File(context.getExternalFilesDir(null), HybridConstants.Resource.BASE_DIR);
        }
        if (appDir == null) {
            appDir = new File(context.getFilesDir(), HybridConstants.Resource.BASE_DIR);
        }
        if (!appDir.exists()) {
            appDir.mkdirs();
        }
    ...
    public static File getBundleDir(Context context) {
        return getAppPath(HybridConstants.Resource.JS_BUNDLE, context);
    }

    public static File getTempBundleDir(Context context) {
        return getAppPath(HybridConstants.Resource.JS_BUNDLE_ZIP, context);
    }
