...
public class NavigationBar extends FrameLayout implements View.OnClickListener {
    ...
    private void findView() {
        ...
        nbBackIv1 = findViewById(R.id.nbLeftIv1);
        nbBackIv1.setOnClickListener(this);
        nbBackTv1 = findViewById(R.id.nbLeftTv1);
        nbBackTv1.setOnClickListener(this);
        nbLeftTv2 = findViewById(R.id.nbLeftTv2);
        nbLeftTv2.setOnClickListener(this);
        nbLeftIv2 = findViewById(R.id.nbLeftIv2);
        nbLeftIv2.setOnClickListener(this);

        nbRightIvs = new AlphaImageView[4];
        nbRightIvs[0] = findViewById(R.id.nbRightIv1);
        nbRightIvs[0].setOnClickListener(this);
        nbRightIvs[1] = findViewById(R.id.nbRightIv2);
        nbRightIvs[1].setOnClickListener(this);
        nbRightIvs[2] = findViewById(R.id.nbRightIv3);
        nbRightIvs[2].setOnClickListener(this);
        nbRightIvs[3] = findViewById(R.id.nbRightIv4);
        nbRightIvs[3].setOnClickListener(this);

        nbRightTvs = new AlphaTextView[2];
        nbRightTvs[0] = findViewById(R.id.nbRightTv1);
        nbRightTvs[0].setOnClickListener(this);
        nbRightTvs[1] = findViewById(R.id.nbRightTv2);
        ...
        nbTitle = findViewById(R.id.nbTitle);
        nbTitle2 = findViewById(R.id.nbTitle2);
        ivTitleArrow = findViewById(R.id.iv_arrow);

        nbCustomTitleLayout = findViewById(R.id.nbCustomTitleLayout);
    }
